...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-22' as date)
                  and date_add(cast('2001-08-22' as date), 14 )
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Bridgeport'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  24624
   and ib_upper_bound   <=  24624 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MI', 'IA', 'VT')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KY', 'OH', 'NE')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('SC', 'OR', 'MO')
...
and d_date between '1999-03-20' and
        date_add(cast('1999-03-20' as date), 90 )
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Terry County','Franklin Parish','Fairfield County','Kittitas County',
                           'Gage County','Harmon County','Sumner County','Raleigh County')
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between date_sub(cast ('1998-03-15' as date), 30 )
                    and date_add(cast ('1998-03-15' as date), 30 )
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 75780808
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 131643214
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 116201008
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 84450646
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 62714526
            then (select avg(ss_ext_tax)
                  from store_sales
...
where
	...
	and d_date between cast('2001-03-27' as date)
                                and date_add(cast('2001-03-27' as date), 30 )
group by
	i_item_id
        ,i_item_desc
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 64 and 64+10 
             or ss_coupon_amt between 14078 and 14078+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 17 and 17+10
          or ss_coupon_amt between 10238 and 10238+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 155 and 155+10
          or ss_coupon_amt between 6021 and 6021+1000
...
select  i_item_id
 ...
 and d_date between cast('1999-05-31' as date)
                                and date_add(cast('1999-05-31' as date), 30)
 group by i_item_id
         ,i_item_desc
         ,i_category
         ,i_class
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-19' as date)
                  and date_add(cast('2001-08-19' as date), 30 )
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 and d_date between cast('1998-07-04' as date) and date_add(cast('1998-07-04' as date), 60 )
 and i_manufact_id in (689,650,803,591)
...
and cc_county in ('Pennington County','Levy County','Richland County','Walker County',
                  'Mesa County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Webster County','Los Angeles County','Floyd County','Early County','Gray County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,3,2,8,12,10) and
       d_year = 2002 and
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-29' as date) 
                  and date_add(cast('1999-08-29' as date), 30 )
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Springfield','Lincoln')
...
select 
 ...
 and cs_warehouse_sk    = w_warehouse_sk
 and cs_sold_date_sk    = d_date_sk
 and d_date between date_sub(cast ('2000-03-07' as date), 30 )
                and date_add(cast ('2000-03-07' as date), 30 )
 group by
    w_state,i_item_id
...
select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 54112 and 54112+28800 
...
where
	...
	and d_date between cast('2000-02-12' as date)
				and date_add(cast('2000-02-12' as date), 30 )
group by
	i_item_id
        ,i_item_desc
        ,i_category
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Fairfield County','Walker County','Arthur County','San Miguel County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Sports','Home','Jewelry') and
          i_class in ('basketball','kids','custom')
         )
      or (i_category in ('Women','Music','Electronics') and
          i_class in ('fragrances','country','stereo') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 671 and 671+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'turquoise' or i_color = 'snow') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-02-07','2000-09-27','2000-11-20')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Crossroads','Oakland','Lakeview','Mount Vernon','Edgewood') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('sandy','seashell','black','peru','misty','spring') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('azure','cornsilk','orchid'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2001
 and     d_moy                   = 1
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-30' as date) and date_add(cast('2002-03-30' as date), 60 )
 and i_manufact_id in (839,730,801,892)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '62046','89526','85296','21879','11716','99602',
                          '37453','68232','69551','26076','61061',
                          '42848','26745','11744','49061','64110',
                          '24130','69073','11561','58328','37732',
                          '23084','35956','40810','36647','83788',
                          '58704','93116','58595','23718','55377',
                          '81570','63830','56636','43016','55653',
                          '21707','13294','53407','96700','86667',
                          '25958','47023','25933','78868','57341',
                          '88874','67465','52947','20999','56855',
                          '74939','49091','11510','52773','20787',
                          '33779','40713','73768','11836','13848',
                          '67141','75046','61290','72146','85721',
                          '44891','21818','74932','11053','47771',
                          '10587','75500','18155','67274','15559',
                          '77862','41647','70013','51783','82437',
                          '79590','86463','24137','98275','77642',
                          '21508','50459','40605','90023','16621',
                          '41918','78990','85875','36888','81469',
                          '79572','49563','24923','71978','90232',
                          '68486','75833','73207','26780','38957',
                          '27743','50709','62451','59746','37248',
                          '25638','18498','52829','66662','49383',
                          '38051','60441','20278','91681','94786',
                          '83261','20169','93868','38861','60456',
                          '79430','48408','71880','42448','22915',
                          '93839','33158','74139','75252','20541',
                          '13631','99592','84860','71434','70100',
                          '73083','25346','39806','45935','15298',
                          '51337','85342','88531','50284','66976',
                          '13197','85080','64664','90660','84299',
                          '40019','59000','32645','62839','38903',
                          '90589','19990','82111','65907','12774',
                          '50234','51447','28651','49411','52696',
                          '50734','94926','73742','51326','27376',
                          '59120','75257','34848','80036','61388',
                          '48053','56231','81987','88140','41584',
                          '17186','48647','93045','51467','97560',
                          '71519','75139','42525','62112','65703',
                          '11232','27070','76524','90036','82172',
                          '64596','78729','30497','68208','85995',
                          '54660','90003','30706','56765','11170',
                          '16270','71208','51606','23309','72486',
                          '65384','29220','93707','68058','32531',
                          '24743','24373','81069','72861','68681',
                          '37867','78339','38557','97810','32927',
                          '99337','34076','25307','73572','39778',
                          '65862','85233','23225','99581','79234',
                          '92427','40228','24894','50906','57962',
                          '37871','57331','40561','51699','83441',
                          '75294','94413','47349','40619','99529',
                          '47243','89221','91652','17917','99877',
                          '25816','34147','20044','59643','66850',
                          '58046','75772','94378','45323','48195',
                          '94518','73073','72377','13773','86191',
                          '76733','78289','69195','99596','71363',
                          '83215','15816','70440','56838','53161',
                          '82189','50545','31368','57994','60439',
                          '99127','47817','50820','23776','17481',
                          '86283','16638','41559','39055','84928',
                          '79560','18978','35593','45299','18960',
                          '73504','23397','61838','86617','59290',
                          '28639','45814','60120','57745','45386',
                          '93664','64771','50974','62158','40964',
                          '88837','24705','73895','12359','45218',
                          '84035','87454','89227','45930','58764',
                          '91012','35744','10976','80398','31960',
                          '77346','79640','81015','69520','37315',
                          '33250','99629','21592','64683','27318',
                          '59463','35256','92250','63183','56540',
                          '86540','88933','55140','54730','37171',
                          '88109','62087','25092','32186','26993',
                          '92835','76650','79319','14925','96321',
                          '12834','87512','94362','92674','32840',
                          '73425','11068','47346','97338','22698',
                          '28267','65786','67514','62956','92984',
                          '56762','51277','69986','81634','67402',
                          '31378','55783','63994','35274','51306',
                          '85205','85303','66517','44871','11684',
                          '51693','64213','23679','23073')
     intersect
      select ca_zip
