...
from pyspark.sql.types import StructType, StructField, DateType, TimestampType, IntegerType, DecimalType, StringType
...
SCHEMAS["customer"] = StructType([
    ...
    StructField("c_last_review_date", CharType(10))
])
